        ...
        <div class="main">
            ...
            <div class="toggler" >
                <div id="effect" class="effectDes">
                    <form id="formulario">
                        <table class="loginc"  style="margin: 0px -54px;">
                            <tr>
                                <td colspan="2" align="center" foreground="white">Iniciar Sesi&oacuten</td>
                            </tr>
                            <tr>
            ...
            <article id="contenido">
                <div class="info1">
                    ...
                    <form name="frmContacto" method="POST"  action="sendEmail.jsp">
